...
urlpatterns = [
    ...
    path('users/first-login-finish/', api.UserFirstLoginFinishApi.as_view(), name='user-finish-first-login'),
    path('system-user/<uuid:pk>/cmd-filter-rules/', api.UserCommandFilterRuleListApi.as_view(), name='user-cmd-filter-rule-list'),
    path('users/names', api.UserNamesViewset.as_view(), name='users-names'),
    path('users/roles', api.UserRolesViewset.as_view(), name='users-roles'),
    path('users/navbars', api.UserNavbarsAPI.as_view(), name='users-navbars'),
    path('users/system-users', api.UserSystemUserAPI.as_view(), name='users-system-user'),
